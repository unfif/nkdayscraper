      ...
      <div class="contents">
        <div class="dispplacerace">
          <div class="dispplace">
            ...
            <button class="dispplace btn btn-outline-secondary btn-sm" @click="dispplace = '京都'; dispcoursetype = 'all'; dispracenum = 'all'; dispallsameraces = false; flipDispPlace();">京都</button>
            <button class="dispplace btn btn-outline-secondary btn-sm" @click="dispplace = '東京'; dispcoursetype = 'all'; dispracenum = 'all'; dispallsameraces = false; flipDispPlace();">東京</button>
          </div>
