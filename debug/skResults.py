...
df = data['records']
# feature_columns = ['場所', 'R', 'タイトル', '形式', '距離', '情報1', '情報2', '情報3', 'レコード', '天候', '状態', '日時', '日程', '時刻', 'グレード', '頭数', '賞金', '着順', '枠番', '馬番', '馬名', '性', '齢', '斤量', '騎手', 'タイム', '着差', '人気', 'オッズ', '上り', '通過', '所属', '調教師', '馬体重', '増減']
feature_columns = ['場所', 'R', 'タイトル', '形式', '距離', '情報1', '情報2', '情報3', 'レコード', '天候', '状態', '日時', '日程', '時刻', 'グレード', '頭数', '賞金', '着順', '枠番', '馬番', '馬名', '性', '齢', '斤量', '騎手', '人気', 'オッズ', '所属', '調教師', '馬体重', '増減']
features_orig = df.query("着差 not in ('除外', '中止', '取消') and 着順 <= 8")[feature_columns]
labels = features_orig['着順']
# %%
from sklearn.preprocessing import LabelEncoder
lb = LabelEncoder()
encoding_columns = ['場所', 'タイトル', '形式', '情報1', '情報2', '情報3', 'レコード', '天候', '状態', '日時', '日程', '時刻', 'グレード', '賞金', '馬名', '性', '齢', '騎手', '所属', '調教師']
